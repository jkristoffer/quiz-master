...
- **Issue**: After answering a question correctly and clicking "Next Level", the success modal from the *previous* level remained visible overlaying the *new* level.
