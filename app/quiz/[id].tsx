...
export default function QuizScreen() {
    ...
    const [feedback, setFeedback] = useState<{ visible: boolean; isCorrect: boolean; message: string }>({
        visible: false,
        isCorrect: false,
        message: ''
    });
        ...
        <ScreenWrapper style={styles.container}>
            ...
            >
                <View style={styles.modalOverlay}>
                    <View style={[styles.modalContent, feedback.isCorrect ? styles.modalCorrect : styles.modalWrong]}>
